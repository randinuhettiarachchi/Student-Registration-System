...
public class student extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(591, 640));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql = "UPDATE STUDENT SET stdName = '"+stdName+"', stdMotherName = '"+stdMother+"', stdBlood = '"+stdBlood+"', stdCity = '"+stdCity+"', stdPhone = '"+stdPhone+"', class = '"+stdclass+"' WHERE id = '"+stdId+"'";
