...
public class addStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setSize(new java.awt.Dimension(414, 575));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String sql ="INSERT INTO STUDENT(stdName, stdMotherName, stdBlood, stdCity, stdPhone, class) VALUES('"+stdName+"', '"+stdMother+"', '"+stdBlood+"', '"+stdCity+"', '"+stdPhone+"', '"+stdclass+"')";
